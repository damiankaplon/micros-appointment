...
It produces the `quarkus-run.jar` filepin the `target/quarkus-app/` directory.
...
You can then execute your native executable with: `./target/security-micro-1.0-SNAPSHOT-runner`
